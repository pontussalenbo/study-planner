...
CREATE TABLE programme_master_course_class (
    ...
    PRIMARY KEY (course_code, class_year),
...
CREATE TABLE course_period_class (
    ...
    FOREIGN KEY (course_code) REFERENCES courses (course_code),
    FOREIGN KEY (course_code, class_year) REFERENCES programme_master_course_class (course_code, class_year)
);
...
CREATE TABLE course_period_year (
    ...
    FOREIGN KEY (course_code) REFERENCES courses (course_code),
    FOREIGN KEY (course_code, academic_year) REFERENCES programme_master_course_year (course_code, academic_year)
);
